...
import { FaPhone, FaMapMarkerAlt, FaGlobe, FaClock, FaStore, FaHospital, FaWhatsapp } from 'react-icons/fa';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-blue-500 hover:shadow-xl transition-shadow duration-300">
                ...
                <a 
                  ...
                  className="text-2xl font-bold text-gray-900 hover:text-blue-600 transition-colors block mb-4"
                >
                  +91 85868 45185
                </a>
                <button
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-orange-500">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="font-bold text-green-700">9:00 AM - 2:00 PM</span>
                </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-green-100 px-8 py-4 rounded-full">
            <p className="text-green-800 font-medium">
              🚚 We also offer delivery services in and around Sohna area
            </p>
          </div>
