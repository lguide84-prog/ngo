    ...
    <div className="bg-white text-black min-h-screen py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-12">
          <button className="inline-flex items-center px-10 py-4 bg-green-600 hover:bg-green-700 text-white font-bold text-lg rounded-lg transition duration-300 transform hover:scale-105 shadow-lg">
