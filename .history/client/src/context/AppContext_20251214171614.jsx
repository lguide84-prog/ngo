...
// Optional: HOC for seller routes
export const withSellerAuth = (Component) => {
  return function WithSellerAuthComponent(props) {
    const { user, isSeller, setShowLogin } = useAppContext();
    ...
    if (!user || !isSeller) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <p className="text-gray-600">Seller account required to access this page.</p>
        </div>
      );
    }
