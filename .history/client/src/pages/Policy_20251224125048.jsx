...
const PrivacyPolicy = () => {
  ...
  const companyInfo = {
    ...
    tagline: 'Your trusted partner for quality agricultural products and solutions',
    contact: {
      phone: '+91 85868 45185',
      whatsapp: '+91 85868 45185',
      email: 'Kuntalagrosohna@gmail.com',
      website: 'kuntalagro.com'
    },
    location: {
      address: 'Shop No.1, Ward No.19, Near Civil Hospital, Sohna, Sohna Rural, Haryana 122103',
      landmark: '63X8+FR Sohna, Haryana',
      googleMaps: 'https://maps.google.com/?q=Shop+No.1+ward+no.19+near+Civil+Hospital+Sohna'
    },
    hours: {
      days: 'Monday - Sunday',
      open: '8:00 AM',
    ...
    store: {
      shopNumber: 'Shop No. 1',
      ward: 'Ward No. 19',
      landmark: 'Near Civil Hospital, Sohna'
    }
  };
  ...
  const sections = [
    {
      ...
      content: `This Privacy Policy explains how ${companyInfo.name} ("we," "us," or "our") collects, uses, discloses, and protects your personal information when you use our agricultural products platform, mobile application, and related services.

Scope: This policy applies to all farmers, agricultural businesses, and users accessing ${companyInfo.name} services in India, particularly those in the Sohna, Haryana region and surrounding areas.
...
Address: ${companyInfo.name}, Data Protection Office,
${companyInfo.location.address}

Business Hours: ${companyInfo.hours.days}, ${companyInfo.hours.open} - ${companyInfo.hours.close}
Current Status: ${companyInfo.hours.status} • Closes ${companyInfo.hours.closesAt}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="flex flex-col items-center justify-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900">{companyInfo.name}</h1>
              <p className="text-emerald-700 font-semibold">{companyInfo.tagline}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8 border border-blue-200">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 mb-2">Find us easily using Google Maps</p>
              <div className="space-y-2">
                <p className="font-semibold text-gray-800">Shop Address:</p>
                <p className="text-gray-600">{companyInfo.location.address}</p>
                <p className="text-sm text-gray-500">Landmark: {companyInfo.location.landmark}</p>
              </div>
              <button
                onClick={() => handleContactAction('maps', companyInfo.location.googleMaps)}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-lg font-bold text-gray-900">{companyInfo.contact.phone}</p>
                <button
                  onClick={() => handleContactAction('phone', companyInfo.contact.phone)}
                  className="px-4 py-2 bg-emerald-100 text-emerald-700 font-semibold rounded-lg hover:bg-emerald-200 transition-colors"
                >
                  Call Now
                </button>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 text-sm">Quick chat & inquiries</p>
                <p className="text-lg font-bold text-gray-900">{companyInfo.contact.whatsapp}</p>
                <button
                  onClick={() => handleContactAction('whatsapp', companyInfo.contact.whatsapp)}
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 text-sm">For detailed inquiries and quotations</p>
                <p className="text-sm font-bold text-gray-900 break-all">{companyInfo.contact.email}</p>
                <button
                  onClick={() => handleContactAction('email', companyInfo.contact.email)}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="font-semibold text-gray-800">{companyInfo.hours.days}</p>
                <p className="text-gray-600">{companyInfo.hours.open} - {companyInfo.hours.close}</p>
                <div className="flex items-center gap-2 mt-2">
                  <div className={`w-2 h-2 rounded-full ${companyInfo.hours.status === 'Open' ? 'bg-green-500' : 'bg-red-500'}`}></div>
                  <span className="font-bold text-gray-800">
                    Currently: {companyInfo.hours.status} · Closes {companyInfo.hours.closesAt}
                  </span>
                </div>
              </div>
              ...
              {/* Store Details */}
              <div className="space-y-4">
                <h4 className="font-bold text-gray-800">Store Details</h4>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 break-all">{companyInfo.contact.website}</p>
                  <button
                    onClick={() => handleContactAction('website', companyInfo.contact.website)}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 break-all">{companyInfo.contact.email}</p>
                </div>

                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Store className="w-4 h-4 text-gray-500" />
                    <span className="font-semibold text-gray-700">Shop Number</span>
                  </div>
                  <p className="text-sm text-gray-600">{companyInfo.store.shopNumber}</p>
                  <p className="text-xs text-gray-500">Located in {companyInfo.store.ward}</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">{companyInfo.store.landmark}</p>
                  <p className="text-xs text-gray-500">Easy to locate</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${companyInfo.contact.email}`} className="text-emerald-700 hover:text-emerald-800 break-all">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${companyInfo.contact.phone}`} className="text-emerald-700 hover:text-emerald-800">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {companyInfo.name} Data Protection Office<br />
                      {companyInfo.location.address}
                    </p>
                  </div>
                </div>
        ...
        <div className="text-center mt-8 pt-8 border-t text-gray-500 text-sm">
          <p className="mb-2">
            <strong>{companyInfo.name} Data Protection</strong> • 
            Policy Version: 2.2 • 
            Effective Date: {new Date().toLocaleDateString('en-IN')}
          </p>
          <p>
            For agricultural emergency or data breach reports, 
            contact: <span className="font-bold text-emerald-700">{companyInfo.contact.email}</span>
          </p>
