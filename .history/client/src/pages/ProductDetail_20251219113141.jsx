            ...
            <div className="mt-6 p-5 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-3 bg-white rounded-lg border">
                  ...
                  <span className={`px-3 py-1.5 rounded text-sm font-medium inline-block ${getCategoryColor(product.category)}`}>
                    {product.category}
                  </span>
                </div>
                {product.subCategory && (
                  <div className="p-3 bg-white rounded-lg border">
                    ...
                    <span className={`px-3 py-1.5 rounded text-sm font-medium inline-block ${getSubCategoryColor(product.category, product.subCategory)}`}>
                      {product.subCategory}
                    </span>
                  </div>
                )}
