  ...
  const sections = [
    {
      ...
      content: `Welcome to Kuntal Agro ("we," "our," or "us"). These Terms and Conditions govern your use of our agricultural products platform. By accessing or using our services, you agree to be bound by these terms. If you disagree with any part, please discontinue use immediately.`
    },
    {
      id: 'definitions',
      title: 'Key Definitions',
      icon: <Scale className="w-5 h-5" />,
      content: `• "User" refers to any individual or entity using Kuntal Agro services.
      ...
      • "Platform" means the Kuntal Agro website and mobile application.`
    },
    {
      id: 'account',
    ...
    },
    {
      ...
      content: `Kuntal Agro is not liable for:
    ...
    },
    {
      ...
      content: `• Kuntal Agro branding, content, and platform are protected.
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-800">Kuntal Agro</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                By using Kuntal Agro's agricultural platform, you acknowledge reading and 
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
              ...
              <label htmlFor="accept-terms" className="text-gray-700">
                ...
                <span className="text-sm">
                  I acknowledge these terms govern my use of Kuntal Agro's agricultural 
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                onClick={() => window.location.href = 'mailto:legal@kuntalagro.com'}
                className="px-6 py-3 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Contact Legal Team
              </button>
        ...
        <div className="text-center text-gray-500 text-sm">
          ...
          <p>
            Kuntal Agro Agricultural Services • support@kuntalagro.com • 
