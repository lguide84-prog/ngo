...
function Addproduct() {
  ...
  const [shippingCharges, setShippingCharges] = useState(""); // ✅ New state for shipping charges
  ...
  const handlefile = async (e) => {
    try {
      ...
      const productData = {
        ...
        shippingCharges: Number(shippingCharges) || 0 // ✅ Include shipping charges
      };
      ...
      if (data.success) {
        ...
        setWeightValue("");
        setGstPercentage("5");
        setShippingCharges(""); // ✅ Reset shipping charges
        setFiles([]);
      } else {
    ...
    <>
      <div className=" no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
        <form onSubmit={handlefile} className="md:p-10 p-4 space-y-5 max-w-lg">
          ...
          {/* Shipping Charges */}
          <div className="flex flex-col gap-1 max-w-md">
            <label className="text-base font-medium" htmlFor="shipping-charges">Shipping Charges (₹) *</label>
            <select 
            ...
            <p className="text-sm text-gray-500 mt-1">
              Select shipping charges for this product
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p className="flex justify-between">
                  ...
                  <span className={Number(shippingCharges) === 0 ? "text-green-600" : ""}>
                    ₹{Number(shippingCharges).toFixed(2)} {Number(shippingCharges) === 0 ? "(Free)" : ""}
                  </span>
                </p>
