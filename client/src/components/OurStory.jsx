      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-2xl md:text-3xl text-green-700 font-semibold">
            Health for the  <span className="text-yellow-600">People & by the People</span>
          </p>
        </header>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-yellow-50 flex items-center justify-center">
                    <div className="text-center p-8">
                      <div className="mb-6">
                        ...
                        <h3 className="text-2xl font-bold text-green-800"> Aayushman Bhava Natural Living Pvt. Ltd.</h3>
                      </div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <p className="text-gray-700 text-lg leading-relaxed">
                Aayushman Bhava Natural Living Pvt. Ltd.: GREEN & GREEN health for sure, is based on the concept to serve “Organic and 100% Natural & Pure Products. We are committed to bring to you products and solutions that support and promote true wellness to the community, unite our species, save our planet, and usher in a golden age of humanity. 

This is what, Aayushman Bhava !! exists for…….
