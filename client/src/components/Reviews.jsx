...
const Reviews = () => {
 const testimonials = [
  {
    id: 1,
    quote: "Best place for pure organic products!",
    content: "I’ve been buying cereals, pulses, and organic oils from here for months now. The quality is amazing and everything feels fresh and chemical-free. Perfect for a healthy lifestyle.",
    author: "SUPRIYA S",
    rating: 5,
    decorativeNumber: "66"
  },
  {
    id: 2,
    quote: "Trusted store for daily essentials",
    content: "From spices to sweeteners, they have everything in one place. I really liked their organic range and fair pricing. Staff is friendly and helps you choose the right products.",
    author: "KANIKA K",
    rating: 5,
    decorativeNumber: "66"
  },
  {
    id: 3,
    quote: "Great quality and natural products",
    content: "I recently bought nuts, seeds, and skincare items from here. Everything is authentic and well-packed. You can really feel the difference compared to regular market products.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-green-50 to-yellow-50 rounded-2xl p-8 md:p-12 mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-green-700 mb-2">5+</div>
